"""
GPT-5 OpenAI Browse Adapter for VERA
...
class GPT5OpenAIBrowseAdapter:
    """OpenAI GPT-5 adapter using web_search_preview for browsecomp."""

    def __init__(self, api_key: str, api_base: str = "https://api.openai.com", api_version: str = "2025-02-01-preview", reasoning_effort: str = "high", reasoning_summary: str = "detailed"):
    ...
    async def process_episodes_batch(self, episodes: List[Dict[str, Any]], output_dir: str, max_concurrent: int = 16) -> Dict[str, Any]:
        print(f"[GPT-5 OpenAI Browse] Batch processing {len(episodes)} episodes (max {max_concurrent} concurrent)")
